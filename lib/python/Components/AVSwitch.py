...
from config import configConfigSliderConfigSelectionConfigSubDictConfigYesNoConfigEnableDisableConfigSubsectionConfigBooleanConfigSelectionNumberConfigNothingNoSave
from Components.About import about
from Tools.CList import CList
from Tools.HardwareInfo import HardwareInfo
from enigma import eAVSwitchgetDesktop
from boxbranding import getBoxTypegetMachineBuildgetBrandOEM
...
class AVSwitch():
    ...
    rates['2160p30'] = {'25Hz': {50: '2160p25'},'30Hz': {60: '2160p30'},'multi': {50: '2160p25',60: '2160p30'}}
    ...
    if about.getChipSetString() in ('7366', '7376', '5272s', '7444', '7445', '7445s'):
        ...
        modes['HDMI'] = [
         '720p', '1080p', '2160p', '2160p30', '1080i', '576p', '576i', '480p', '480i']
        ...
        modes['HDMI'] = [
         '720p', '1080i', '576p', '576i', '480p', '480i']
    ...
    def getFramebufferScale(self):
        ...
        return (
         aspect[0] * fb_size.height(), aspect[1] * fb_size.width())
...
def InitAVSwitch():
    ...
    if getBoxType() in ('gbquad', 'gbquadplus', 'et5x00', 'ixussone', 'ixusszero',
                        'axodin', 'axodinc', 'starsatlx', 'galaxym6', 'geniuse3hd',
                        'evoe3hd', 'axase3', 'axase3c', 'omtimussos1', 'omtimussos2',
                        'gb800seplus', 'gb800ueplus', 'gbultrase', 'gbultraue', 'gbultraueh',
