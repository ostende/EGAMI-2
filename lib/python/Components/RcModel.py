...
# [GCC 5.4.0 20160609]
# Embedded file name: /usr/lib/enigma2/python/Components/RcModel.py
# Compiled at: 2017-10-02 01:50:15
from boxbranding import getBoxTypegetMachineBrandgetMachineBuildgetBrandOEM
...
class RcModel:
    ...
    def getRcFolder(self):
        ...
        if os.path.exists('/proc/stb/info/azmodel'):
        ...
        elif boxtype in ('zgemmah6', 'zgemmah4', 'zgemmahs', 'zgemmah2s', 'zgemmah2h',
                         'zgemmah5', 'zgemmah52s', 'zgemmah3ac', 'zgemmah5ac', 'zgemmah52tc',
                         'zgemmah32tc', 'zgemmah7', 'zgemmah7s', 'zgemmah7c', 'zgemmah52splus',
                         'zgemmah2splus'):
            remotefolder = 'zgemma3'
        elif boxtype in 'zgemmai55':
            remotefolder = 'zgemma5'
        elif boxtype in ('gbquad', 'gb800se', 'gb800ue', 'gb800solo', 'gb800seplus',
                         'gb800ueplus', 'gbipbox', 'gbultrase', 'gbultraue', 'gbx1',
                         'gbx3'):
            remotefolder = 'gb0'
            ...
            remotefolder = 'gb3'
        elif boxtype in ('mutant11', 'mutant1100', 'mutant1200', 'mutant530c', 'mutant500c',
                         'vizyonvita', 'mutant1265', 'mutant1500', 'mutant51', 'bcm7251s',
                         'vimastec1000', 'vimastec1500'):
            remotefolder = 'hd1100'
        ...
        elif boxtype in ('iqonios100hd', 'iqonios200hd', 'iqonios300hd', 'iqonios300hdv2',
                         'roxxs200hd', 'mediaart200hd', 'force2se', 'force2', 'force2plus',
                         'force2plushv', 'force2nano'):
            remotefolder = 'iqon1'
        elif boxtype in ('force1', 'force1plus', 'worldvisionf1', 'worldvisionf1plus'):
            remotefolder = 'iqon2'
        elif boxtype in ('force3uhdplus', 'force3uhd'):
            remotefolder = 'iqon3'
        elif boxtype in ('formuler1', 'formuler3', 'formuler4', 'formuler4turbo', 'formuler1tc',
                         'formuler3ip', 'formuler4ip'):
            ...
            remotefolder = 'dmm1'
        elif boxtype in ('dm7080', 'dm7020hd', 'dm7020hdv2', 'dm800sev2', 'dm500hdv2',
                         'dm820', 'dm520', 'dm525', 'dm900', 'dm920'):
            remotefolder = 'dmm2'
            ...
            if boxtype in ('mbmicro', 'mbmicrov2', 'mbtwinplus'):
                ...
                remotefolder = 'ini3'
        elif boxtype in ('xpeedlx', 'xpeedlx1', 'xpeedlx2', 'xpeedlx3', 'atemio5x00',
                         'atemio6000', 'atemio6100', 'atemio6200', 'atemionemesis',
                         'sezammarvel'):
            remotefolder = 'ini4'
        ...
        elif boxtype in ('optimussos', 'optimussos1', 'optimussos2', 'optimussos1plus',
                         'optimussos2plus'):
