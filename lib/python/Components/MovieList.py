...
import struct
import random
from enigma import eListboxPythonMultiContenteListboxgFontiServiceInformationeSizeRT_HALIGN_LEFTRT_HALIGN_RIGHTRT_VALIGN_CENTEReServiceReferenceeServiceCentereTimergetDesktoploadPNGBT_SCALEBT_KEEP_ASPECT_RATIO
from GUIComponent import GUIComponent
from Tools.FuzzyDate import FuzzyTime
from Components.MultiContent import MultiContentEntryTextMultiContentEntryPixmapAlphaTestMultiContentEntryPixmapAlphaBlendMultiContentEntryProgress
from Components.config import config
from Tools.LoadPixmap import LoadPixmap
from Tools.Directories import SCOPE_ACTIVE_SKINresolveFilename
        ...
        if serviceref.flags & eServiceReference.mustDescent:
            ...
            if ext != '0':
                ...
                try:
                    ...
                    print (
                     '[MovieList] load extended infos get failed: ', e)
                ...
                if ext == '2':
                    try:
                        ...
                        print (
                         '[MovieList] load picon get failed: ', e)
