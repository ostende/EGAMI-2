...
from Tools.Directories import fileExistsresolveFilenameSCOPE_PLUGINS
    ...
    def loadBasePlugins(self, directory):
        ...
        for c in os.listdir(directory):
            ...
            for pluginname in os.listdir(directory_category):
                ...
                if pluginname.endswith('Wizard') or pluginname in ('EGAMIPluginSpeedUp',
                                                                   'OpenWebif', 'WeatherPlugin',
