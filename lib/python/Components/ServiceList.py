...
from enigma import eListboxServiceContenteListboxeServiceCentereServiceReferencegFonteRecteSize
from Tools.LoadPixmap import LoadPixmap
from Tools.TextBoundary import getTextBoundarySize
from Tools.Alternatives import GetWithAlternative
from Tools.Directories import resolveFilenameSCOPE_ACTIVE_SKINfileExists
...
def findPicon(serviceName):
    pngname = config.usage.picon_dir.value + serviceName + '.png'
...
def getServiceListPiconName(serviceName):
    ...
    if not pngname:
        ...
        if len(fields) > 2 and fields[2] != '2':
            fields[2] = '1'
        if len(fields) > 0 and (fields[0] == '4097' or fields[0] == '5002'):
            fields[0] = '1'
