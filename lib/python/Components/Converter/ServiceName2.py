...
from enigma import iServiceInformationiPlayableServiceiPlayableServicePtreServiceReferenceeServiceCentereTimergetBestPlayableServiceReference
...
class ServiceName2(Converter, object):
    ...
    def getProviderName(self, ref):
        if isinstance(ref, eServiceReference):
            from Screens.ChannelSelection import service_types_radioservice_types_tv
