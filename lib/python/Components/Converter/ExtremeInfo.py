...
from enigma import eServiceCentereServiceReferenceiServiceInformationiPlayableServiceeDVBFrontendParametersSatelliteeDVBFrontendParametersCable
from string import upper
from Components.ServiceEventTracker import ServiceEventTracker
from Tools.Directories import fileExistsresolveFilename
from os import environlistdirremoverenamesystem
from Components.ServiceEventTracker import ServiceEventTracker
import gettext
            ...
            if frontendData is not None:
                if frontendData.get('tuner_type') == 'DVB-S' or frontendData.get('tuner_type') == 'DVB-C':
                    ...
                    if frontendData.get('tuner_type') == 'DVB-S':
                        try:
                            orb = {3590: 'Thor/Intelsat (1.0W)',3560: 'Amos (4.0W)',
                        ...
                        if self.tunertype == 'linelist':
                            pol = {eDVBFrontendParametersSatellite.Polarisation_Horizontal: 'H',eDVBFrontendParametersSatellite.Polarisation_Vertical: 'V',eDVBFrontendParametersSatellite.Polarisation_CircularLeft: 'CL',
                            ...
                            pol = {eDVBFrontendParametersSatellite.Polarisation_Horizontal: 'Horizontal',eDVBFrontendParametersSatellite.Polarisation_Vertical: 'Vertical',
                        ...
                        fec = {eDVBFrontendParametersSatellite.FEC_None: 'None',eDVBFrontendParametersSatellite.FEC_Auto: 'Auto',eDVBFrontendParametersSatellite.FEC_1_2: '1/2',
                        ...
                        fec = {eDVBFrontendParametersCable.FEC_None: 'None',eDVBFrontendParametersCable.FEC_Auto: 'Auto',eDVBFrontendParametersCable.FEC_1_2: '1/2',
