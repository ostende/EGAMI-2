...
from enigma import iServiceInformationiPlayableServiceiPlayableServicePtr
from enigma import eServiceCentereServiceReferenceiServiceInformation
...
class EGServiceName(Converter, object):
    ...
    def getText(self):
        ...
        if not info:
            ...
            if self.type == self.SERVICENUMBER:
                return number
            return
