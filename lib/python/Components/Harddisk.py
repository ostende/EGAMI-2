...
from boxbranding import getMachineNamegetBoxTypegetMachineBuild
import Task
...
class HarddiskManager():
    ...
    def __init__(self):
        ...
        p = [
         (
          '/', _('Internal Flash')), ('/media/upnp', _('DLNA'))]
    ...
    def getBlockDevInfo(self, blockdev):
        ...
        try:
            ...
            if os.path.exists(devpath + '/dev'):
                ...
                dev = None
            if getMachineBuild() in ('et1x000', 'vuuno4k', 'vuultimo4k', 'vusolo4k',
                                     'hd51', 'hd52', 'sf4008', 'dm900', 'dm7080',
                                     'dm820', 'gb7252', 'dags7252', 'vs1500', 'h7',
                                     'xc7439', '8100s', 'et13000'):
                devlist = [
                 1, 7, 31, 253, 254, 179]
            else:
                devlist = [
