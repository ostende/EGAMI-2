...
from enigma import eDVBFrontendParametersSatelliteeDVBFrontendParametersTerrestrialeDVBFrontendParametersCableeDVBFrontendParametersATSCeDVBFrontendParameterseDVBResourceManagereTimer
    ...
    def updateStatus(self):
        ...
        if dict['tuner_state'] == 'TUNING':
            ...
            if dict['tuner_state'] == 'LOSTLOCK' or dict['tuner_state'] == 'FAILED':
                ...
                self.failedTune.append([self.currTuned, self.oldTuned, 'tune_failed', dict])
