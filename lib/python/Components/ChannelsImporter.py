...
# [GCC 5.4.0 20160609]
# Embedded file name: /usr/lib/enigma2/python/Components/ChannelsImporter.py
# Compiled at: 2017-10-02 01:52:08
from Components.config import config
from time import mktimestrftimetimelocaltime
from enigma import eTimer
import os
import re
import urllib2
from enigma import eServiceReferenceeDVBDB
...
class AutoClientModeTimer:
    ...
    def getClientModeTime(self):
        ...
        nowt = time()
        now = localtime(nowt)
        if config.clientmode.scheduleRepeatInterval.value.isdigit():
    ...
    def doneConfiguring(self):
        ...
        elif autoClientModeTimer is not None:
            ClientModeTime = 0
