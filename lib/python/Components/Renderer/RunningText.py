...
from enigma import eWidgeteLabeleTimerePointeSizegFontRT_HALIGN_LEFTRT_HALIGN_CENTERRT_HALIGN_RIGHTRT_HALIGN_BLOCKRT_VALIGN_TOPRT_VALIGN_CENTERRT_VALIGN_BOTTOMRT_WRAP
