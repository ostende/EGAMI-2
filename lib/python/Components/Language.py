...
import locale
import os
from Tools.Directories import SCOPE_LANGUAGEresolveFilename
            ...
            if lang in self.ll:
                if country == 'GB' or country == 'BR':
                    if lang + '_' + country in self.ll:
                        self.lang[str(lang + '_' + country)] = (
                         name, lang, country, encoding)
    ...
    def delLanguage(self, delLang=None):
        ...
        if delLang:
            ...
            for x in ll:
                ...
                elif x != lang[:2] and x != 'en' and x != 'de' and x != 'fr':
                    os.system('opkg remove --autoremove --force-depends ' + Lpackagename + x)
                elif x == 'pt':
                    if x != lang:
                        os.system('opkg remove --autoremove --force-depends ' + Lpackagename + x)
