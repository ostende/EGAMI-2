...
from boxbranding import getBrandOEMgetBoxTypegetMachineBrand
from enigma import eDVBDBeEPGCachesetTunerTypePriorityOrdersetPreferredTunersetSpinnerOnOffsetEnableTtCachingOnOffeEnvMisc_OptionseBackgroundFileErasereServiceEventeDVBFrontendRT_HALIGN_LEFTRT_HALIGN_RIGHTRT_HALIGN_CENTERRT_VALIGN_CENTERRT_WRAP
from Components.About import about
from Components.Harddisk import harddiskmanager
from config import ConfigSubsectionConfigYesNoconfigConfigSelectionConfigTextConfigNumberConfigSetConfigLocationsNoSaveConfigClockConfigIntegerConfigBooleanConfigPasswordConfigIPConfigSliderConfigSelectionNumberConfigFloatConfigDictionarySetConfigDirectory
from Tools.Directories import resolveFilenameSCOPE_HDDSCOPE_TIMESHIFTSCOPE_VODSCOPE_AUTORECORDSCOPE_SYSETCdefaultRecordingLocationfileExists
...
def InitUsageConfig():
    ...
    if getBrandOEM() in ('vuplus', 'ini', 'ceryon', 'broadmedia'):
    ...
    choicelist = [
     (
      '-1', _('Disable')), ('0', _('Eventname only'))]
    ...
    choicelist = [
     (
      'standby', _('Standby')), ('deepstandby', _('Deep Standby'))]
    ...
    choicelist = [
     (
      'show_menu', _('Show shutdown menu')), ('shutdown', _('Immediate shutdown')), ('standby', _('Standby')), ('standby_noTVshutdown', _('Standby without TV shutdown')), ('sleeptimer', _('SleepTimer')), ('powertimerStandby', _('PowerTimer Standby')), ('powertimerDeepStandby', _('PowerTimer DeepStandby'))]
    ...
    nims = [
     (
      '-1', _('auto')), ('expert_mode', _('Expert mode')), ('experimental_mode', _('Experimental mode'))]
    ...
    priority_strictly_choices = [
     (
      'no', _('No')), ('yes', _('Yes')), ('while_available', _('While available'))]
    ...
    config.usage.channelbutton_mode = ConfigSelection(default='0', choices=[
     ...
     (
      '2', _('Bouquet List'))])
    config.usage.arrowupdownbutton_mode = ConfigSelection(default='1', choices=[
     (
      '0', _('Open Service List for PiP')),
     (
      '1', _('Open Bouqet List'))])
    ...
    if SystemInfo['WakeOnLAN']:
        ...
        def wakeOnLANChanged(configElement):
            if getBoxType() in ('et7000', 'et7100', 'et7500', 'gbx1', 'gbx2', 'gbx3',
                                'gbx3h', 'et10000', 'gbquadplus', 'gbquad', 'gb800ueplus',
                                'gb800seplus', 'gbultraue', 'gbultraueh', 'gbultrase',
                                'gbipbox', 'quadbox2400', 'mutant2400', 'et7x00',
                                'et8500', 'et8500s'):
