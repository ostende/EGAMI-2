...
from enigma import eComponentScaniDVBFrontendeTimer
                ...
                if transponder:
                    ...
                    if tp_type == iDVBFrontend.feSatellite:
                        ...
                        tp_text = '%s %d%c / %d / %s' % (tp_text, tp.frequency / 1000,
                         {tp.Polarisation_Horizontal: 'H',tp.Polarisation_Vertical: 'V',tp.Polarisation_CircularLeft: 'L',tp.Polarisation_CircularRight: 'R'
                            }.get(tp.polarisation, ' '),
                         tp.symbol_rate / 1000,
                         {tp.FEC_Auto: 'AUTO',tp.FEC_1_2: '1/2',tp.FEC_2_3: '2/3',tp.FEC_3_4: '3/4',
                            tp.FEC_5_6: '5/6',tp.FEC_7_8: '7/8',tp.FEC_8_9: '8/9',
                            tp.FEC_3_5: '3/5',tp.FEC_4_5: '4/5',tp.FEC_9_10: '9/10',
                        ...
                        tp_text = 'DVB-C %s %d / %d / %s' % (
                         {tp.Modulation_Auto: 'AUTO',tp.Modulation_QAM16: 'QAM16',
                            ...
                            tp.Modulation_QAM128: 'QAM128',tp.Modulation_QAM256: 'QAM256'
                            }.get(tp.modulation, ''),
                         tp.frequency,
                         tp.symbol_rate / 1000,
                         {tp.FEC_Auto: 'AUTO',tp.FEC_1_2: '1/2',tp.FEC_2_3: '2/3',tp.FEC_3_4: '3/4',
                            tp.FEC_5_6: '5/6',tp.FEC_7_8: '7/8',tp.FEC_8_9: '8/9',
                            tp.FEC_3_5: '3/5',tp.FEC_4_5: '4/5',tp.FEC_9_10: '9/10',tp.FEC_None: 'NONE'}.get(tp.fec_inner, ''))
