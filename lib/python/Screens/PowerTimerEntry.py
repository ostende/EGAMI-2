...
from Components.config import ConfigSelectionConfigSelectionNumberConfigSubListConfigDateTimeConfigClockConfigYesNoConfigIntegergetConfigListEntryConfigIP
...
from PowerTimer import AFTEREVENTTIMERTYPE
...
class TimerEntry(Screen, ConfigListScreen):
    ...
    def keyGo(self, result=None):
        ...
        self.timer.timerType = {'nothing': TIMERTYPE.NONE,'wakeup': TIMERTYPE.WAKEUP,
