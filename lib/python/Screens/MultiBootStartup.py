...
# [GCC 5.4.0 20160609]
# Embedded file name: /usr/lib/enigma2/python/Screens/MultiBootStartup.py
...
from os import pathlistdirsystem
...
class MultiBootStartup(ConfigListScreen, Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['WizardActions', 'SetupActions', 'ColorActions'], {'left': self.left,
           'right': self.right,
           'up': self.up,
           'down': self.down,
           'green': self.save,
    ...
    def getCurrent(self):
        self.optionsList = (
         (
          'boxmode=1', _('2160p60 without PiP (Standard)')), ('boxmode=12', _('2160p50 with PiP (Experimental)')))
