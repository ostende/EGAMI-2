...
from Components.config import configgetConfigListEntryConfigNothingNoSaveConfigPINconfigfile
...
from enigma import eServiceCentereTimereServiceReference
