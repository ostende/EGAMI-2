...
from Screens.TimerEntry import TimerEntryTimerLog
from Tools.BoundFunction import boundFunction
from Tools.FuzzyDate import FuzzyTime
from Tools.Directories import resolveFilenameSCOPE_HDDfileExists
from time import timelocaltime
from timer import TimerEntry as RealTimerEntry
from enigma import eServiceCentereEPGCache
...
class TimerEditList(Screen):
    ...
    def __init__(self, session):
        ...
        self['Event'] = Event()
        self['actions'] = ActionMap(['OkCancelActions', 'DirectionActions', 'ShortcutActions', 'TimerEditActions'], {'ok': self.openEdit,
           'cancel': self.leave,
    ...
    def toggleDisabledState(self):
        ...
        if cur:
            ...
            if t.disabled:
                ...
                if t.repeated:
                    list = ((_('Stop current event but not future events'), 'stoponlycurrent'),
                     (
    ...
    def updateState(self):
        ...
        if showCleanup and self.key_blue_choice != self.CLEANUP:
            ...
            if not showCleanup and self.key_blue_choice != self.EMPTY:
...
class TimerSanityConflict(Screen):
    ...
    def __init__(self, session, timer):
        ...
        self.key_yellow_choice = self.EMPTY
        self.key_blue_choice = self.EMPTY
        self['actions'] = ActionMap(['OkCancelActions', 'DirectionActions', 'ShortcutActions', 'TimerEditActions'], {'ok': self.leave_ok,
