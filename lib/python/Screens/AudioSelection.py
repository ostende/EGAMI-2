...
from Screens.Setup import getConfigMenuItemSetup
from Screens.InputBox import PinInput
from Screens.MessageBox import MessageBox
from Components.ServiceEventTracker import ServiceEventTracker
from Components.ActionMap import NumberActionMap
from Components.ConfigList import ConfigListScreen
from Components.config import configConfigSubsectiongetConfigListEntryConfigNothingConfigSelectionConfigOnOff
...
from enigma import iPlayableServiceeTimereSize
...
class AudioSelection(Screen, ConfigListScreen):
    ...
    def fillList(self, arg=None):
        ...
        if self.settings.menupage.value == PAGE_AUDIO:
            ...
            if SystemInfo['CanAC3plusTranscode']:
                choice_list = [
                 (
                  'use_hdmi_caps', _('controlled by HDMI')), ('force_ac3', _('always'))]
            ...
            if SystemInfo['Can3DSurround']:
                choice_list = [
                 (
                  'none', _('off')), ('hdmi', _('HDMI')), ('spdif', _('SPDIF')), ('dac', _('DAC'))]
            ...
            if SystemInfo['Can3DSpeaker'] and config.av.surround_3d.value != 'none':
                choice_list = [
                 (
                  'center', _('center')), ('wide', _('wide')), ('extrawide', _('extra wide'))]
            ...
            for x in subtitlelist:
                ...
                if x[0] == 0:
                    ...
                    types = ('unknown', 'embedded', 'SSA file', 'ASS file', 'SRT file',
                             'VOB file', 'PGS file')
                    try:
            ...
            if self.infobar.selected_subtitle and self.infobar.selected_subtitle != (0,
                                                                                     0,
                                                                                     0,
                                                                                     0) and ".DVDPlayer'>" not in `(self.infobar)`:
    ...
    def keyRight(self, config=False):
        if config or self.focus == FOCUS_CONFIG:
            ...
            elif self.settings.menupage.value == PAGE_SUBTITLES and self.infobar.selected_subtitle and self.infobar.selected_subtitle != (0,
                                                                                                                                          0,
                                                                                                                                          0,
                                                                                                                                          0):
