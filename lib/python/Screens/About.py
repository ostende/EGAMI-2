...
from Components.Harddisk import Harddiskharddiskmanager
from Components.NimManager import nimmanager
from Components.About import about
from Components.Label import Label
from Components.ScrollLabel import ScrollLabel
from Components.Console import Console
from enigma import eTimergetEnigmaVersionString
from boxbranding import getBoxTypegetMachineBuildgetMachineBrandgetMachineNamegetImageVersiongetImageBuildgetDriverDategetOEVersion
...
def getAboutText():
    ...
    if getMachineBuild() in ('vusolo4k', 'vuultimo4k'):
        ...
        cpuMHz = '   (1,3 GHz)'
                               ...
                               '8100s'):
        cpuMHz = '   (1,7 GHz)'
    elif getMachineBuild() in ('et13000', 'et1x000', 'hd52', 'hd51', 'sf4008', 'vs1500',
                               'h7'):
        try:
            import binascii
    ...
    if getMachineBuild() not in ('et13000', 'et1x000', 'hd51', 'hd52', 'vusolo4k',
                                 'vuuno4k', 'vuultimo4k', 'sf4008', 'dm820', 'dm7080',
                                 'dm900', 'gb7252', 'dags7252', 'vs1500', 'h7', 'xc7439',
                                 '8100s'):
        AboutText += _('Installed:\t%s') % about.getFlashDateString() + '\n'
    AboutText += _('Last update:\t%s') % getEnigmaVersionString() + '\n\n'
    AboutText += _('WWW:\t%s') % about.getImageUrlString()
    return (
     AboutText, AboutLcdText)
