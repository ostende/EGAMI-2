...
from os import listdirremoverenamesystempopenpath
from enigma import eListboxPythonMultiContenteTimergFontloadPNGRT_HALIGN_RIGHTgetDesktop
...
from Tools.Directories import fileExistsSCOPE_ACTIVE_SKINresolveFilename
from twisted.internet import reactor
from twisted.web.client import HTTPClientFactory
from urlparse import urlparseurlunparse
...
class CCcamShareViewMenu(Screen, HelpableScreen):
    ...
    def __init__(self, session, url):
        ...
        self['reshare'] = Label()
        self['title'] = Label()
        self['actions'] = HelpableNumberActionMap(self, 'CCcamInfoActions', {'cancel': (
                    self.exit, _('close share view')),
           '0': (
           ...
           'ok': (
                self.getServer, _("get the cards' server"))
           }, -1)
