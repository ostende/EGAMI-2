...
from time import localtimemktimetimestrftime
from datetime import datetime
from enigma import eEPGCache
from Screens.Screen import Screen
import ChannelSelection
from ServiceReference import ServiceReference
from Components.config import configConfigSelectionConfigTextConfigSubListConfigDateTimeConfigClockConfigYesNogetConfigListEntry
...
class TimerEntry(Screen, ConfigListScreen):
    ...
    def __init__(self, session, timer):
        ...
        self['cancel'] = Pixmap()
        self.createConfig()
        self['actions'] = NumberActionMap(['SetupActions', 'GlobalActions', 'PiPSetupActions', 'ColorActions'], {'ok': self.keySelect,
           'save': self.keyGo,
    ...
    def createConfig(self):
        ...
        self.timerentry_justplay = ConfigSelection(choices=[
         (
          'zap', _('zap')), ('record', _('record')), ('zap+record', _('zap and record'))], default={0: 'record',1: 'zap',2: 'zap+record'}[justplay + 2 * always_zap])
