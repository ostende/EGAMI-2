...
from Components.config import configConfigInteger
from Components.Label import Label
from Components.ServiceEventTracker import ServiceEventTracker
from Components.Sources.Boolean import Boolean
from enigma import eDVBSatelliteEquipmentControleTimeriPlayableServiceeServiceCenteriServiceInformation
    ...
    def getTurnTime(self, start, end, pol=0):
        ...
        if mrt > 0:
            ...
            try:
                ...
                mrt = round(mrt * 1000 / int(self.getTurningSpeed(pol)) / 10000) + 3
