...
from boxbranding import getImageVersiongetImageType
from urllib import urlopen
import socket
import os
from Screens.ParentalControlSetup import ProtectedScreen
from Components.Language import language
from enigma import eConsoleAppContainereDVBDB
...
from Components.config import configConfigSubsectionConfigYesNogetConfigListEntryconfigfileConfigText
...
from Tools.Directories import resolveFilenamefileExistsSCOPE_PLUGINSSCOPE_ACTIVE_SKINfileExists
...
class PluginBrowser(Screen, ProtectedScreen):
    ...
    def __init__(self, session):
        ...
        self['NumberAction'] = NumberActionMap(['NumberActions'], {'0': self.resetSortOrder
           }, -1)
        ...
        if val:
            if self.type == self.DOWNLOAD:
                if self['list'].l.getCurrentSelection()[0].name.startswith('picons-'):
                    supported_filesystems = frozenset(('vfat', 'ext4', 'ext3', 'ext2',
                                                       'reiser', 'reiser4', 'jffs2',
                                                       'ubifs', 'rootfs'))
                    candidates = []
