...
from boxbranding import getImageVersiongetImageBuildgetImageDistrogetImageTypegetMachineBrandgetMachineNamegetMachineBuild
from os import renamepathremove
from gettext import dgettext
import urllib
import socket
from enigma import eTimereDVBDB
