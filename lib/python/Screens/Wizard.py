...
from enigma import eTimereEnv
from Screens.Screen import Screen
from Screens.MessageBox import MessageBox
from Components.config import configConfigTextConfigPasswordKEY_LEFTKEY_RIGHTKEY_0KEY_DELETEKEY_BACKSPACEKEY_ASCIIConfigSelectionConfigBoolean
...
class Wizard(Screen):
    ...
    def __init__(self, session, showSteps=True, showStepSlider=True, showList=True, showConfig=True):
        ...
        self['actions'] = NumberActionMap(['WizardActions', 'DirectionActions', 'NumberActions', 'ColorActions', 'SetupActions', 'InputAsciiActions', 'KeyboardInputActions'], {'gotAsciiCode': self.keyGotAscii,
           'ok': self.ok,
           'back': self.back,
           'left': self.left,
           'right': self.right,
        ...
        self['VirtualKB'] = NumberActionMap(['VirtualKeyboardActions'], {'showVirtualKeyboard': self.KeyText
           }, -2)
