...
from Components.PowerTimerList import PowerTimerListgettimerTypegetafterEvent
from Components.Sources.StaticText import StaticText
from Components.Sources.ServiceEvent import ServiceEvent
from PowerTimer import PowerTimerEntryAFTEREVENT
from Screens.Screen import Screen
from Screens.ChoiceBox import ChoiceBox
from Screens.MessageBox import MessageBox
from Screens.PowerTimerEntry import TimerEntryTimerLog
    ...
    def toggleDisabledState(self):
        ...
        if cur:
            ...
            if t.disabled:
                ...
                if t.repeated:
                    list = ((_('Stop current event but not coming events'), 'stoponlycurrent'),
                     (
