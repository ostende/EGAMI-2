...
# [GCC 5.4.0 20160609]
# Embedded file name: /usr/lib/enigma2/python/Screens/ClientMode.py
# Compiled at: 2017-10-02 01:52:09
from Components.ActionMap import ActionMap
from Components.config import configconfigfilegetConfigListEntryConfigSubListConfigSubsection
...
class ClientModeScreen(ConfigListScreen, Screen):
    ...
    def saveconfig(self):
        nim_config_list = []
        if self.initial_state != config.clientmode.enabled.value and self.initial_state == False:
            nim_config_list = []
        ...
        elif self.initial_state != config.clientmode.enabled.value:
            import json
