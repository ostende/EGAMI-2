...
from enigma import eDVBFrontendParametersSatelliteeDVBFrontendParametersCableeDVBFrontendParametersTerrestrialeDVBFrontendParametersATSC
...
def ConvertToHumanReadable(tp, tunertype=None):
    ...
    if tunertype == 'DVB-S':
        ...
        if ret['system'] == 'DVB-S2':
            ret['rolloff'] = {eDVBFrontendParametersSatellite.RollOff_alpha_0_35: '0.35',eDVBFrontendParametersSatellite.RollOff_alpha_0_25: '0.25',
        ...
        ret['pls_mode'] = {eDVBFrontendParametersSatellite.PLS_Root: _('Root'),
