...
LanguageCodes['ell'] = LanguageCodes['gre'] = LanguageCodes['el'] = ('Greek, Modern (1453-)',
                                                                     'Latin/greek')
...
LanguageCodes['ina'] = LanguageCodes['ia'] = ('Interlingua (International Auxiliary Language Association)',
                                              'International aux.')
...
LanguageCodes['mkd'] = LanguageCodes['mac'] = LanguageCodes['mk'] = ('Macedonian',
                                                                     'Slavic')
...
LanguageCodes['oci'] = LanguageCodes['oc'] = ('Occitan (post 1500); Proven\xe7al',
                                              'Romance')
...
class ISO639Language:
    ...
    def __init__(self, depth=PRIMARY):
        ...
        if depth == self.PRIMARY:
            wanted_languages = [
             'Undetermined', 'English', 'German', 'Arabic', 'Catalan', 'Croatian', 'Czech', 'Danish', 'Dutch', 'Estonian', 'Finnish', 'French', 'Greek', 'Hungarian', 'Lithuanian', 'Latvian', 'Icelandic', 'Italian', 'Norwegian', 'Polish', 'Portuguese', 'Russian', 'Serbian', 'Slovakian', 'Slovenian', 'Spanish', 'Swedish', 'Turkish', 'Ukrainian']
        ...
        for lang, id_list in self.idlist_by_name.iteritems():
            ...
            for long_id in long_ids:
                self.name_and_shortid_by_longid[long_id] = (
                 short_id, lang)
