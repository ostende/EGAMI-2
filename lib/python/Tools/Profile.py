...
import time
from Directories import resolveFilenameSCOPE_CONFIG
    ...
    if profile_file:
        ...
        if id in profile_data:
            ...
            try:
                ...
                elif boxtype in ('amikomini', 'amiko8900', 'sognorevolution', 'arguspingulux',
                                 'arguspinguluxmini', 'sparkreloaded', 'sabsolo',
                                 'sparklx', 'gis8120'):
                    f = open('/proc/vfd', 'w')
                    f.write('%d \n' % perc)
                else:
